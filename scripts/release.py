...
PLUGIN_MARKETPLACE_NAME = "ccs-plus-local"

STANDALONE_SKILL_NAME: str | None = "ccsp-provider-manage"
STANDALONE_SKILL_SOURCE: Path | None = REPOSITORY_ROOT / "skills" / "ccsp-provider-manage"
